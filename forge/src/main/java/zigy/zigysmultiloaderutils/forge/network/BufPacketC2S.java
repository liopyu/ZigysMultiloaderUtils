...
import zigy.zigysmultiloaderutils.utils.forge.NetworkManagerImpl;

import java.util.function.Supplier;

public class BufPacketC2S {

    public FriendlyByteBuf data;
    public ResourceLocation id;

    public BufPacketC2S(FriendlyByteBuf buf, ResourceLocation id) {
        this.data = buf;
        this.id = id;
    }

    public BufPacketC2S(FriendlyByteBuf buf) {
